...
async def panel(interaction: discord.Interaction):
    ...
    embed = discord.Embed(
        ...
        description=(
            "Pay for your **wezzy.store** order using Robux:\n\n"
            "**1.** Click **Pay with Robux** below.\n"
            "**2.** Enter your **Order ID** and **Roblox username**.\n"
            "**3.** Buy the gamepass link the bot sends you.\n"
            "**4.** Your order is delivered automatically. ✅\n\n"
            "⚠️ Make sure your Discord **DMs are open** so we can deliver your product."
        ),
        color=0x2B2D31,
    )
    await interaction.channel.send(embed=embed, view=PayPanelView())
